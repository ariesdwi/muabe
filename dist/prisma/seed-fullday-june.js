...
const SLOTS = [
    {
        ...
        status: client_1.BookingStatus.APPROVED, agreedPrice: 800_000,
        approvedAt: '2026-05-25T08:00:00Z',
        hasPaymentProof: true, paymentStatus: client_1.PaymentStatus.APPROVED,
    },
    {
        ...
        status: client_1.BookingStatus.APPROVED, agreedPrice: 1_000_000,
    ...
    },
    {
        ...
        status: client_1.BookingStatus.APPROVED, agreedPrice: 600_000,
    ...
    },
    {
        ...
        status: client_1.BookingStatus.APPROVED, agreedPrice: 2_700_000,
    ...
    },
    {
        ...
        status: client_1.BookingStatus.APPROVED, agreedPrice: 1_500_000,
    ...
    },
    {
        ...
        status: client_1.BookingStatus.APPROVED, agreedPrice: 2_800_000,
    ...
    },
    {
        ...
        status: client_1.BookingStatus.PENDING_PAYMENT, agreedPrice: 450_000,
    },
    {
        ...
        status: client_1.BookingStatus.APPROVED, agreedPrice: 2_500_000,
    ...
    },
    {
        ...
        status: client_1.BookingStatus.WAITING_APPROVAL, agreedPrice: 650_000,
        hasPaymentProof: true, paymentStatus: client_1.PaymentStatus.WAITING_APPROVAL,
    },
];
async function main() {
    ...
    for (const slot of SLOTS) {
        ...
        if (!customerId)
            throw new Error(`Customer not found: ${slot.customerEmail}`);
        if (!serviceId)
            throw new Error(`Service not found: ${slot.serviceSlug}`);
        ...
        if (slot.hasPaymentProof && slot.paymentStatus) {
            const isApproved = slot.paymentStatus === client_1.PaymentStatus.APPROVED;
        ...
        await prisma.auditLog.create({
            data: {
                userId: admin.id,
                action: slot.status === client_1.BookingStatus.APPROVED ? 'BOOKING_APPROVED' : 'BOOKING_CREATED',
                entityType: 'Booking',
                entityId: booking.id,
...
//# sourceMappingURL=seed-fullday-june.js.map