...
const BOOKING_TEMPLATES = [
    {
        ...
        adminNote: 'Tiket dan akomodasi sudah dipesan. Konfirmasi keberangkatan H-5.',
    },
    {
    ...
    },
    {
        ...
        hasPaymentProof: true,
        paymentStatus: client_1.PaymentStatus.APPROVED,
        adminNote: 'Trial makeup sudah dilakukan tgl 28 Mei, klien setuju dengan hasil.',
    },
    {
    ...
    },
    {
        ...
        agreedPrice: 600_000,
        rejectionReason: 'Tanggal sudah fully booked untuk bridal di pagi hari, tidak bisa double shift.',
...
async function main() {
    ...
    console.log(`   Found ${services.length} services, ${customers.length} customers\n`);
    ...
    for (const tmpl of BOOKING_TEMPLATES) {
        ...
        if (!serviceId)
            throw new Error(`Service not found: ${tmpl.serviceSlug}`);
        const bookingData = {
            customerId,
            serviceId,
        ...
        console.log(`   ✓  [${tmpl.eventDate}] ${tmpl.serviceSlug} – ${tmpl.status}`);
    }
...
//# sourceMappingURL=seed-dummy-june.js.map